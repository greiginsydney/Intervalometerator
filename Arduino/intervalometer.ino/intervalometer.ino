...
#define MEMTemp0      0x0B  // First memory location for temperature reading. (Midnight).
#define MEMTemp23     0x42  // This define isn't actually used in the code, it's just a reminder of the last MEM address I've used (11pm)
#define MEMVolt0      0x43  // First memory location for voltage reading. (Midnight).
#define MEMVolt23     0x5A  // This define isn't actually used in the code, it's just a reminder of the last MEM address I've used (11pm)
